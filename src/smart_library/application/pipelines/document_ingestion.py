...
class DocumentIngestionService:
    ...
    def ingest(self, pdf_path: str, extract_metadata: bool = False):
...
def ingest_document(pdf_path: str, extract_metadata: bool = False):
    """
    ...
    return ingestion_service.ingest(pdf_path, extract_metadata=extract_metadata)
